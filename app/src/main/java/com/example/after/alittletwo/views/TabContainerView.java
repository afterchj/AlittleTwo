package com.example.after.alittletwo.views;
...
public class TabContainerView extends LinearLayout {
    ...
    public void initContainer(String[] titles, int[][] iconsRes, int[] colors, boolean showTransitionColor) {
        ...
        this.mTextNormalColor = ContextCompat.getColor(getContext(), colors[0]);
        this.mTextSelectedColor = ContextCompat.getColor(getContext(), colors[1]);// getResources().getColor(colors[1]);
